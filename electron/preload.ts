...
contextBridge.exposeInMainWorld('electron', {
    ...
    fileSystem: {
        ...
        checkExistsForRecents: (path: string) => ipcRenderer.invoke('check-path-exists', path, 'recents'),
        checkPathsExistsForRecents: (paths: string[]) => ipcRenderer.invoke('check-paths-exists', paths, 'recents'),
