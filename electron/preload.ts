...
contextBridge.exposeInMainWorld('electron', {
    ...
    fileSystem: {
        ...
        checkExists: (path: string, caller?: string) => ipcRenderer.invoke('check-path-exists', path, caller),
        checkPathsExists: (paths: string[], caller?: string) => ipcRenderer.invoke('check-paths-exists', paths, caller),
