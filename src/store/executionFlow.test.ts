...
describe('Quokka-like Execution Flow', () => {
    ...
    it('should clear previous results on new execution', async () => {
        ...
        // Use unique code to bypass lastExecutedCode check and ensure buffer reset
        runExecution('const unique = 999;');
        ...
        runExecution('const unique = 1000;');

        // Simulate backend triggering clear
